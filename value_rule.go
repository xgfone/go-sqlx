...
// ValueRule validates or transforms data when [RuleColumn.Apply], [RuleColumn.Set] or
// [RuleColumn.ColValue] is called. [ValueRule.Apply] must not panic, mutate input data, or
// return SQL
